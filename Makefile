...
#    Updated: 2025/02/25 22:00:52 by jpancorb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CHECK_FILES  = checker_ambient checker checker_camera checker_cylinder \
			   checker_plane checker_sphere checker_light check_limits checker_cone
COLORS_FILES = colors
...
INTERSEC_FILES = intersections plane_intersection sphere_intersection \
				 cylinder_intersection cylinder_body cylinder_caps cone_intersection
